...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"ajan","description":"AI-safe MCP server for schema-aware, read-only SQL access.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Guide","link":"/"},{"text":"Tools","link":"/tools"},{"text":"Security","link":"/security"}],"sidebar":[{"text":"Documentation","items":[{"text":"Overview","link":"/"},{"text":"Tools","link":"/tools"},{"text":"Security","link":"/security"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/borakilicoglu/ajan"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
